...
export function LampDemo() {
  return (
    <LampContainer className="rounded-[2rem]   ">
      <motion.h1
        ...
        className="bg-gradient-to-br z-20 from-orange-200 via-slate-900 to-amber-400 dark:from-slate-100 dark:via-slate-300 dark:to-slate-500 py-4 bg-clip-text text-center text-4xl font-bold leading-tight tracking-tight text-transparent md:text-6xl"
      >
        Remember Dost!
        <br />
      ...
      <motion.p
        ...
        className="mt-4 text-center text-xl font-medium text-slate-600 md:text-2xl"
      >
        Start Your Journey !
      </motion.p>
    </LampContainer>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[70vh]  flex-col items-center justify-center overflow-hidden dark:bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 dark:h-56 overflow-visible w-[30rem] bg-gradient-conic from-orange-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 dark:h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-orange-500 text-white [--conic-position:from_290deg_at_center_top]"
        >
