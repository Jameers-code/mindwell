...
const MedicationModal = () => {
  ...
  const { closeMedicationModal, isMedicationModalOpen } = useSettingsModal();
    ...
    return (
      <Dialog open={isMedicationModalOpen} onOpenChange={closeMedicationModal}>
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            <DialogTitle className="font-bold text-orange-500 text-[23px]">
          ...
          <div className="pt-3">
            <Form {...form}>
              <form
                ...
                className="flex space-y-2 flex-col gap-y-4 w-full relative"
              >
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Textarea
                        ...
                        className="w-full  font-semibold  max-h-20"
                      />
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel htmlFor="frequency">
                        How often do you make time for self-care activities like
